        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            {isDashUserPath && (
                <div className="p-4">
                    ...
                    <div className="relative flex flex-col items-center justify-center p-8 md:p-12 lg:p-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white text-center mt-4 mb-6 rounded-lg shadow-lg overflow-hidden">
                        <img src={bienvenida_comunidad_estudiantil} alt="Bienvenida Comunidad Estudiantil" className="absolute inset-0 h-full w-full object-cover opacity-30 transform rotate-3" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="flex flex-col items-center justify-center bg-white shadow-lg p-4 transition-transform transform hover:scale-105">
                            <img src={icono_crecimiento_profesional} alt="Crecimiento Profesional" className="h-40 w-40 rounded-full mb-2" />
                            <h3 className="font-semibold text-lg text-gray-700 text-center">Crecimiento Profesional</h3>
                            <p className="text-center text-gray-600">Descubre las herramientas que te ayudarán a crecer en tu carrera.</p>
                        </div>
                        <div className="flex flex-col items-center justify-center bg-white shadow-lg p-4 transition-transform transform hover:scale-105">
                            <img src={estudiante_en_biblioteca} alt="Desarrollo Profesional" className="h-40 w-40 rounded-full mb-2" />
                            <h3 className="font-semibold text-lg text-gray-700 text-center">Desarrollo Profesional</h3>
                            <p className="text-center text-gray-600">Mejora tus habilidades y prepárate para el futuro.</p>
                        </div>
                        <div className="flex flex-col items-center justify-center bg-white shadow-lg p-4 transition-transform transform hover:scale-105">
                            <img src={grafico_carrera_exito} alt="Crecimiento Carrera" className="h-40 w-40 rounded-full mb-2" />
                            <h3 className="font-semibold text-lg text-gray-700 text-center">Crecimiento Carrera</h3>
                            <p className="text-center text-gray-600">Visualiza tu éxito y establece tus metas profesionales.</p>
                        </div>
                        <div className="flex flex-col items-center justify-center bg-white shadow-lg p-4 transition-transform transform hover:scale-105">
                            <img src={apoyo_en_aula} alt="Apoyo Estudiantil" className="h-40 w-40 rounded-full mb-2" />
                            <h3 className="font-semibold text-lg text-gray-700 text-center">Apoyo Estudiantil</h3>
                            <p className="text-center text-gray-600">Encuentra recursos y asistencia para tus estudios.</p>
                        </div>
                        <div className="flex flex-col items-center justify-center bg-white shadow-lg p-4 transition-transform transform hover:scale-105">
                            <img src={evento_feria_empleo} alt="Prácticas y Empleos" className="h-40 w-40 rounded-full mb-2" />
                            <h3 className="font-semibold text-lg text-gray-700 text-center">Prácticas y Empleos</h3>
                            <p className="text-center text-gray-600">Conéctate con empresas y encuentra oportunidades laborales.</p>
                        </div>
                        <div className="flex flex-col items-center justify-center bg-white shadow-lg p-4 transition-transform transform hover:scale-105">
                            <img src={seleccion_ofertas_laborales} alt="Elegir Oferta" className="h-40 w-40 rounded-full mb-2" />
                            <h3 className="font-semibold text-lg text-gray-700 text-center">Elegir Oferta</h3>
                            <p className="text-center text-gray-600">Evalúa tus opciones y elige la oferta que mejor se adapte a ti.</p>
                        </div>
                    </div>
                </div>
            )}
